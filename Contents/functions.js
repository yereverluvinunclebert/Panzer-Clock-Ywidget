...
var mainWindow, mainWindowwidthDefault, mainWindowheightDefault,
		...
		widgetName, switchFacesButton, prefs, till, background2, background, smallHourHand, smallMinuteHand,
...
function menuitem6OnClick() {
	...
	if (answer === 1) {
		openURL("https://www.deviantart.com/yereverluvinuncleber/art/Panzer-Clock-and-Stopwatch-Yahoo-Widget-736825315");
	}
}
//=====================
//End function
...
function showFace() {
	if (preferences.clockFaceSwitchPref.value === "stopwatch") {
		...
		secondTextAreaxo = 262;
		secondTextAreayo = 322;
	} else {
		...
		dateTextArea.visible = true;
		secondTextAreaxo = 325;
		secondTextAreayo = 210;
